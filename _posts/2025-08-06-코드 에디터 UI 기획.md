...
코드 에디터는 Trivial Interactive의 “[**InGame Code Editor**](https://assetstore.unity.com/packages/tools/gui/ingame-code-editor-144254)” 에셋을 기반으로 기능들을 추가하거나 변경하여 만들어졌다. 다음과 같은 기능들을 직접 개발하였다.
