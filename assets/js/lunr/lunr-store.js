var store = [{
        ...
        "excerpt":"작업 기간: 2025-08-27 ~ 2025-09-03 기획 구직 스트레스에 시달리던 2025년 8월 27일, 게임을 만들어야겠다고 결심한다. 아이디어 도출 새로운 게임에 대한 아이디어는 항상 경험해본 게임, 좋아하는 요소들을 늘어놓는 데서 시작한다. 내가 좋아하는 게임 요소들을 티어로 나눠보면 다음과 같다. Tier 1 미소녀 애니메이션 스타일 팬서비스 공장 자동화 프로그래밍 Tier 2 VR 추리...","categories": ["기획","프로그래밍"],
        "tags": ["C#","Unity3D","VR"],
        "url": "/posts/run-squat-warrior-mvp1",
        "teaser": null
      },{
        "title": "공주님을 부탁해! 버그리포트 통계",
        "excerpt":"2023년 6월 초, 공주님을 부탁해! 알파, 베타 테스트를 진행했습니다. 이 과정에서 얻은 이슈량에 관한 통계입니다. notion에 정리된 버그리포트 및 이슈들 당시 테스트 기간 동안 총 164개 이슈가 있었고, 133개 이슈에 대응했었습니다. 알파 테스트: 팀 내부 테스트 베타 테스트: 테스터를 모집하여 진행하는 테스트 날짜에 따른 이슈량 변화 구분 날짜 버그 리포트...","categories": ["프로그래밍"],
        "tags": ["공주님을부탁해!"],
