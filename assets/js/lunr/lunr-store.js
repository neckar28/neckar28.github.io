var store = [{
        ...
        "excerpt":"2023년 6월 초, 공주님을 부탁해! 베타 테스트를 진행했습니다. 당시에 테스트를 진행하면서 얻은 이슈량에 관한 통계입니다. notion에 정리된 버그리포트 및 이슈들 당시 테스트 기간 동안 총 164개 이슈가 있었고, 133개 이슈에 대응했었습니다. 알파 테스트: 팀 내부 테스트 베타 테스트: 테스터를 모집하여 진행하는 테스트 날짜에 따른 이슈량 변화 구분 날짜 버그 리포트...","categories": ["프로그래밍"],
        "tags": ["공주님을부탁해!"],
